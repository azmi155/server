...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EryGw8xrC9VSJReUusJ2.CBz5NHW3HOQhhuqUz2mXGG.f8xKu+b/Ed1g4mejyBay26Dpm1rxd4E5JXEyVV+fWZA=')
nadya.loginResult()
print "Azmi-Login Success\n\n=====[Sukses Login]====="
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus Azmi")
